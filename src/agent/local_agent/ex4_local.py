...
def run_ex4_local(user_text: str, history):
    if history is None:
...
def main() -> None:
    console.print("Exercise 4 local (TOOLS). Type 'exit' to quit.")
    ...
    while True:
        ...
        for _ in range(10):
            ...
            assistant = (resp["message"]["content"] or "").strip()
            console.print(f"[raw] {assistant[:400]}")
